...
void PIT_IRQHandler(void)
{
    ...
    {
		  All_Button_Scan();
			if((Time_Cnt1 > 0) && (Time_Cnt1 < 60000))//Bufunt计时用
        {
            Time_Cnt1++;
        }
			if((Time_Cnt2 > 0) && (Time_Cnt2 < 60000))//Bufunt计时用
        {
            Time_Cnt2++;
        }
