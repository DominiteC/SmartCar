...
extern const uint8*  	  hanzi[15];


extern const uint8      banshou				[8][16];
extern const uint8 			dianlaotie		[8][16];
extern const uint8 			shoudianzuan	[8][16];
extern const uint8 			juanchi				[8][16];
extern const uint8 			luosidao			[8][16];
extern const uint8 			qianzi				[8][16];
extern const uint8 			shiboqi				[8][16];
extern const uint8 			wanyongbiao		[8][16];
extern const uint8 			dayinji				[8][16];
extern const uint8 			jianpan				[8][16];
extern const uint8 			shouji				[8][16];
extern const uint8 			shubiao				[8][16];
extern const uint8 			erji					[8][16];
extern const uint8 			xianshiqi			[8][16];
extern const uint8 			yinxiang			[8][16];
